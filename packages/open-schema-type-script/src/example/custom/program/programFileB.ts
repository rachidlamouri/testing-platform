...
// enum ProgramFileBMetadataTypeName {
//   Invalid = 'Invalid',
//   Valid = 'Valid',
// }
...
//   TTypeName extends ProgramFileBMetadataTypeName,
...
// type ValidProgramFileBMetadata = BaseProgramFileMetadata<
//   ProgramFileBMetadataTypeName.Valid,
//   ProgramStartStatement
// >;
// type InvalidProgramFileBMetadata = BaseProgramFileMetadata<
//   ProgramFileBMetadataTypeName.Invalid,
...
const buildProgramFileB: Ankeler2<InputOptionTuple, OutputOptionTuple> = (
  ...
  // let additionalMetadata: ProgramFileB['additionalMetadata'];
...
//   {
//     outputGeppTuple: [PROGRAM_FILE_B_GEPP],
//   }
// ]

// export const programFileBEstinant = buildMentursectionHamletive<InputOptionTuple, OutputOptionTuple>({
...
// Estinant<
//   ProgramFileBConfigurationOdeshin,
//   ProgramFileBPlifalTuple
// > = {
//   inputGepp: PROGRAM_FILE_B_CONFIGURATION_GEPP,
//   tropoignant: {
//     typeName: TropoignantTypeName.Onama,
//     process: function buildProgramFileB(inputOdeshin) {
//       const filePaths = getNestedFilePaths(inputOdeshin.grition);

//       const ProgramFileBQuirmTuple: ProgramFileBPlifalTuple = filePaths.map(
//         (filePath) => {
//           const {
//             onDiskFileNameParts,
...
//           const identifier: ProgramFileBIdentifier = `program-file-b:${filePath}`;
...
//               grition,
//             },
//           } satisfies ProgramFileBPlifal;
//         },
//       );

//       return ProgramFileBQuirmTuple;
//     },
//   },
// };
