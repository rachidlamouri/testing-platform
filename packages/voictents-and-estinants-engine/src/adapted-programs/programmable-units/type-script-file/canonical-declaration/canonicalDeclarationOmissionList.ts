...
export const canonicalDeclarationOmissionList: LintAssertionOmission[] = [
  ...
  'packages/voictents-and-estinants-engine/src/package-agnostic-utilities/constructor-function/constructorFunctionBuilder.ts',
  ...
  'packages/voictents-and-estinants-engine/src/package-agnostic-utilities/constructor-function/types.ts',
  'packages/voictents-and-estinants-engine/src/package-agnostic-utilities/file/getNestedFilePaths.ts',
  'packages/voictents-and-estinants-engine/src/layer-agnostic-utilities/serializeRuntimeStatistic.ts',
