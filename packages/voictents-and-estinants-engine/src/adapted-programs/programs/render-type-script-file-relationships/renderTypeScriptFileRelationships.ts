      ...
      initialHubblepupPelueTuple: [
        createBoundaryConfiguration([
          ...
          },
          {
            ...
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/adapter',
          },
          {
          ...
          },
          {
            ...
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/programs/categorize-files',
          },
          {
            displayName: 'Program - Comments Example',
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/programs/comments-example',
          },
          {
            displayName: 'Program - Find Unused Exports',
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/programs/find-unused-exports',
          },
          {
            displayName: 'Program - Get Snapshot Refresh Script',
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/programs/get-snapshot-refresh-script',
          },
          {
            displayName: 'Program - Model CI',
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/programs/model-ci',
          },
          {
            displayName: 'Program - Model Programs',
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/programs/model-programs',
          },
          {
            displayName: 'Program - Render TypeScript File Relationships',
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/programs/render-type-script-file-relationships',
          },
          {
            displayName: 'Program - Scaffold Voictent File',
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/programs/scaffold-voictent-file',
          },
          {
            displayName: 'Program - Test Graph Render',
            directoryPath:
              'packages/voictents-and-estinants-engine/src/adapted-programs/programs/test-graph-render',
          },
          {
