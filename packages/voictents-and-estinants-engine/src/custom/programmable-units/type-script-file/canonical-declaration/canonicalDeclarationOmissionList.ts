...
export const canonicalDeclarationOmissionList: LintAssertionOmission[] = [
  ...
  'packages/voictents-and-estinants-engine/src/custom/adapter/estinant-builder/estinantBuilder.ts',
  'packages/voictents-and-estinants-engine/src/custom/adapter/estinant-builder/estinantBuilderContext.ts',
  'packages/voictents-and-estinants-engine/src/custom/adapter/estinant-builder/partialAppreffinge.ts',
  'packages/voictents-and-estinants-engine/src/custom/adapter/estinant-builder/vicken.ts',
  'packages/voictents-and-estinants-engine/src/custom/programmable-units/engine-program/input-output/engineEstinantInput2.ts',
  'packages/voictents-and-estinants-engine/src/custom/programmable-units/engine-program/input-output/engineEstinantOutput2.ts',
  'packages/voictents-and-estinants-engine/src/custom/programmable-units/error/programError.ts',
  'packages/voictents-and-estinants-engine/src/custom/programmable-units/graph-visualization/directed-graph/types.ts',
  'packages/voictents-and-estinants-engine/src/custom/programmable-units/in-memory-cache/abstractInMemoryVoictent2.ts',
  'packages/voictents-and-estinants-engine/src/custom/programmable-units/type-script-file-relationships/getDirectoryInstanceIdByFilePath.ts',
  ...
  'packages/voictents-and-estinants-engine/src/custom/programs/render-knowledge-graph/app/browser/factProps.ts',
  ...
  'packages/voictents-and-estinants-engine/src/custom/programs/scaffold-file/types.ts',
