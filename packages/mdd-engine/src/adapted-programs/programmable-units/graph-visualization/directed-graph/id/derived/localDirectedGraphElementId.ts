...
export const LOCAL_DIRECTED_GRAPH_ELEMENT_ID_CONSTRUCTOR_SET = [
  DirectedSubgraphId,
  DirectedClusterId,
  DirectedGraphNodeId,
  DirectedEdgeId,
...
type DistributedLocalDirectedGraphElementId<
  TIdConstructor = typeof LOCAL_DIRECTED_GRAPH_ELEMENT_ID_CONSTRUCTOR_SET[number],
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
> = TIdConstructor extends ConstructorFunction<Tuple<any>, any>
  ? InstanceType<TIdConstructor>
  : never;

export type LocalDirectedGraphElementId =
  DistributedLocalDirectedGraphElementId;
