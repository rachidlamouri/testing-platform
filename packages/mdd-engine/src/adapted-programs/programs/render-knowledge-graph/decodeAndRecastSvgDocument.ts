...
import { treeifyDatum } from './treeifyDatum';
...
export const decodeAndRecastSvgDocument = buildProgrammedTransform({
  ...
  .onTransform((svgDocument, factCollection) => {
    ...
    const filePath = `packages/mdd-engine/src/adapted-programs/programs/render-knowledge-graph/app/browser/generated/${fileName}.tsx`;
    const programCode = [
